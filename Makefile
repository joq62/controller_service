...
eunit: 
	...
	erlc -I include\
	 -I /home/joq62/erlang/include\
	 -I ../catalog_service/include\
	 -o test_ebin ../catalog_service/src/*.erl;
	erlc -I include\
	 -I /home/joq62/erlang/include\
	 -I ../deployment_service/include\
	 -o test_ebin ../deployment_service/src/*.erl;
